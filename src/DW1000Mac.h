...
public:
	...
	static void decodeBlinkFrame(uint8_t frame[], uint8_t shortAddress[]);
	static void decodeShortMACFrame(uint8_t frame[], uint8_t address[]);
	static void decodeLongMACFrame(uint8_t frame[], uint8_t address[]);
